...
int findClosestToEnd(int end, std::vector<City*> originalCities, std::vector<int> *neighbors){
...
std::pair<std::vector<int>, int> linkernighan(std::vector<int> tour, std::vector<City*> originalCities, int cost){
